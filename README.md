...
Arranges characters in a zigzag pattern and reads them row by row.

### 7. Reverse Integer

Reverses digits of an integer while checking for overflow.

### 8. String to Integer (atoi)

Parses a string to an integer, handling signs, whitespace, and overflow.

### 9. Palindrome Number

Checks if an integer reads the same forward and backward by reversing it.
